...
export default function MenuPage() {
  return (
    <View style={styles.container}>
      ...
      <Link href="/(main)" style={styles.link}><Text style={styles.linkText}>Home (Welcome)</Text></Link>
      <Link href="/(main)/universities" style={styles.link}><Text style={styles.linkText}>University List</Text></Link>
